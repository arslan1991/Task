...
var TabbedArea = _require4.TabbedArea;
var TabPane = _require4.TabPane;
...
function CTabbedArea(rawMemberDecls) {
	return new Type("tabbed-area", function makeTabbedArea(ctx) {
		...
		return new TabbedAreaNode(value.selectedView || 0, function (key) {
			return updateTo(_extends({}, value, { selectedView: key }));
		}, preprocessMembers(rawMemberDecls, ctx));
	});
}

var TabbedAreaNode = (function (_GroupNode) {
	_inherits(TabbedAreaNode, _GroupNode);

	function TabbedAreaNode(selected, select, members) {
		_classCallCheck(this, TabbedAreaNode);

		_get(Object.getPrototypeOf(TabbedAreaNode.prototype), "constructor", this).call(this, members);
		this._selected = selected;
		this._select = select;
	}

	_createClass(TabbedAreaNode, [{
		key: "render",
	...
	return TabbedAreaNode;
})(GroupNode);

module.exports = { CTabbedArea: CTabbedArea, TabbedAreaNode: TabbedAreaNode };
//# sourceMappingURL=../maps/lib/tabbed-area.js.map