...
var View = function View(name, render) {
...
var WorkbenchNode = (function (_Node) {
	_inherits(WorkbenchNode, _Node);

	function WorkbenchNode() {
		_classCallCheck(this, WorkbenchNode);

		_get(Object.getPrototypeOf(WorkbenchNode.prototype), "constructor", this).apply(this, arguments);
	}

	_createClass(WorkbenchNode, [{
		key: "render",
...
module.exports = { View: View, CWorkbench: CWorkbench };
//# sourceMappingURL=../maps/lib/workbench.js.map